...
class CuciBasah : AppCompatActivity() {
    ...
    lateinit var basah_img_back : ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cuci_basah)

        basah_img_back = findViewById(R.id.basah_img_back)
        ...
        basah_img_back.setOnClickListener{
