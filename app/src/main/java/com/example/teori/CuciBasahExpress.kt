...
class CuciBasahExpress : AppCompatActivity() {
    ...
    lateinit var express_img_back : ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cuci_basah_express)

        express_img_back = findViewById(R.id.express_img_back)
        ...
        express_img_back.setOnClickListener {
