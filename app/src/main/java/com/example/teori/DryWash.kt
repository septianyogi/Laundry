...
class DryWash : AppCompatActivity() {
    ...
    lateinit var dry_img_back : ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dry_wash)
        ...
        dry_img_back = findViewById(R.id.dry_img_back)
        ...
        dry_img_back.setOnClickListener{
